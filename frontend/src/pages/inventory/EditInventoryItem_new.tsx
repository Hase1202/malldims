...
export default function EditInventoryItem({ itemId, onClose }: EditInventoryItemProps) {
    ...
    return (
        <>
            ...
            {/* Slide-in panel */}
            <div 
                className={`fixed inset-0 right-0 w-[500px] bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${isVisible ? 'translate-x-0' : 'translate-x-full'} z-50`}
                onClick={stopPropagation}
            >
                <div className="h-full overflow-y-auto">
                    <div className="p-8">
